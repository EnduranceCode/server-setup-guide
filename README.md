...
1. [Initial Setup](./01-initial-server-setup.md)
    ...
    3. [Create a non-root user](./01-initial-server-setup.md#13-create-a-non-root-user)
    4. [Setup SSH key-based login](./01-initial-server-setup.md#14-setup-ssh-key-based-login)
    5. [Test the user SSH keys and secure the SSH server](./01-initial-server-setup.md#15-test-the-user-ssh-keys-and-secure-the-ssh-server)
    6. [Install and configure Fail2Ban](./01-initial-server-setup.md#16-install-and-configure-fail2ban)
    7. [Set up the firewall](./01-initial-server-setup.md#17-set-up-the-firewall)
    8. [Git](./01-initial-server-setup.md#18-git)
    9. [Bash prompt customization](./01-initial-server-setup.md#19-bash-prompt-customization)
    10. [Additional folders in the home folder](./01-initial-server-setup.md#110-additional-folders-in-the-home-folder)
